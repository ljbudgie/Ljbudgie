...
[![burgess-principle stars on GitHub](https://img.shields.io/github/stars/ljbudgie/burgess-principle?style=flat-square&label=burgess-principle%20stars)](https://github.com/ljbudgie/burgess-principle/stargazers)
[![Latest burgess-principle release](https://img.shields.io/github/v/release/ljbudgie/burgess-principle?style=flat-square&label=latest%20release)](https://github.com/ljbudgie/burgess-principle/releases)
[![Last commit to burgess-principle](https://img.shields.io/github/last-commit/ljbudgie/burgess-principle?style=flat-square&label=last%20updated)](https://github.com/ljbudgie/burgess-principle/commits/main)
[![MIT licensed open-source projects](https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square)](https://opensource.org/licenses/MIT)
[![UK certification mark UK00004343685](https://img.shields.io/badge/UK_certification_mark-UK00004343685-black?style=flat-square)](https://github.com/ljbudgie/burgess-principle)
[![Sovereign Local Mode for Iris AI](https://img.shields.io/badge/AI-Sovereign%20Local%20Mode-6E40C9?style=flat-square)](https://github.com/ljbudgie/burgess-principle/blob/main/SOVEREIGN_MODE.md)
...
- [The problem — and my answer](#the-problem--and-my-answer)
...
*Diagram: a real-world dispute is captured locally, classified by Mirror/Advocate Companion, reasoned over by Iris + Mythos, sealed with cryptographic receipts, and then tested against the Burgess Principle — resolving to **SOVEREIGN** (record accepted), **NULL** (escalate with proof), or **AMBIGUOUS** (force a direct answer).*
...
| Need | Route |
| --- | --- |
| Use the framework or templates | MIT-open core in [burgess-principle](https://github.com/ljbudgie/burgess-principle) |
| Contribute docs, templates, tests, or integrations | [CONTRIBUTING.md](https://github.com/ljbudgie/burgess-principle/blob/main/CONTRIBUTING.md) + lazy-consensus governance |
| Understand project decision-making | [GOVERNANCE.md](https://github.com/ljbudgie/burgess-principle/blob/main/GOVERNANCE.md) |
| Prepare an organisation for certified adoption | [CERTIFICATION_TIERS.md](https://github.com/ljbudgie/burgess-principle/blob/main/CERTIFICATION_TIERS.md) + [certification site](https://certify.theburgessprinciple.com) |
| Track adoption and cases | [ADOPTION.md](https://github.com/ljbudgie/burgess-principle/blob/main/ADOPTION.md) + [STATUS.md](https://github.com/ljbudgie/burgess-principle/blob/main/STATUS.md) |
...
<sub>Open-source projects are **MIT-licensed**. The Burgess Principle certification mark is separately governed under **UK00004343685** by The Burgess Principle Limited, company number **17199287**, with a parallel **USPTO certification mark filing** in progress.</sub>
